...
main(void)
  {
    ...
    assert(__MCF_teb_load_ptr(0x1480 + tls_index * 8) == 0x0123456789ABCDEF);
    ...
    __MCF_teb_store_ptr(0x1480 + tls_index * 8, 0x13577531AFFADCCD);
    ...
    assert(__MCF_teb_load_ptr(0x0E10 + tls_index * 4) == (int32_t) 0x89ABCDEF);
    ...
    __MCF_teb_store_ptr(0x0E10 + tls_index * 4, 0x13577531);
